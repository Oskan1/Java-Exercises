...
// cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, the method should return true because of
...
public class Main {
    ...
    public static boolean canPack(int bigCount, int smallCount, int goal){
        ...
        int numberBigCount = 5 * bigCount;
        return (numberBigCount + smallCount >= goal && smallCount >= goal%5);
    }
}
